...
import { FaLaptopCode, FaUniversity, FaBuilding } from "react-icons/fa";
    ...
    <div className="relative">
      ...
      <div className="space-y-12">
        ...
        <div className={`w-full max-w-md p-6 bg-white shadow-lg rounded-lg ${
                  index % 2 === 0 ? "ml-16 text-left" : "mr-16 text-right"
                }`}>
        <h3 className="text-2xl font-semibold text-gray-800 text-center">{edu.institution}</h3>
